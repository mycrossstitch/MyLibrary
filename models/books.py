...
class BooksModel(Model):
    ...
    id: Mapped[int] = mapped_column(primary_key = True, init = False) # Первичный ключ (Primary Key)
    ...
    is_read: Mapped[bool] = mapped_column(default=False) # Прочитана ли книга (по умолчанию False)